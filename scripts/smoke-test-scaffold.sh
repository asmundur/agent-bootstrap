...
require_text "Infrastructure And YAML Contract TDD" "bootstrap-templates/templates/universal/skills/tdd.md.tmpl"
require_text "preflight validation before host, cloud, DNS, database, queue, secret, or" "bootstrap-templates/templates/universal/skills/tdd.md.tmpl"
require_text "Do not weaken a guardrail just to make a deploy pass" "bootstrap-templates/templates/universal/skills/tdd.md.tmpl"
require_text "When the user asks you to monitor, babysit, follow through, or see a run through to deployment" "bootstrap-templates/templates/universal/AGENTS.md.tmpl"
require_text "Drifting off a monitoring mission" "bootstrap-templates/templates/universal/anti-patterns.md.tmpl"
...
assert_state_accurate() {
  ...
  if [[ -f "${tmp}/AGENTS.md" ]]; then
    ...
    require_text "When the user asks you to monitor, babysit, follow through, or see a run through to deployment" "${tmp}/AGENTS.md"
    require_file "${tmp}/.codex/skills/audit-beads-quality.md"
    require_file "${tmp}/.antigravity/skills/audit-beads-quality.md"
    require_text "Infrastructure And YAML Contract TDD" "${tmp}/.codex/skills/tdd.md"
    require_text "Drifting off a monitoring mission" "${tmp}/.agents/anti-patterns.md"
