...
You are running the `tdd` skill for **agent-bootstrap**. Your job is to drive implementation through small feedback loops instead of large unverified code drops.
