...
You are running the `improve-architecture` skill for **agent-bootstrap**. Your job is to find architecture hotspots and turn them into clearer, deeper modules with simpler interfaces.
